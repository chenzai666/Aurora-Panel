...
# 全局下载地址配置
DOCKER_COMPOSEV4_URL="https://github.com/chenzai666/Aurora-Panel/releases/download/v1.4.3/docker-compose-v4.yml"
DOCKER_COMPOSEV6_URL="https://github.com/chenzai666/Aurora-Panel/releases/download/v1.4.3/docker-compose-v6.yml"
GOST_SQL_URL="https://github.com/chenzai666/Aurora-Panel/releases/download/v1.4.3/gost.sql"
